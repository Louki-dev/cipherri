<!-- View Account Modal-->
<div id="view-account" class="modal rounded transparent modal-fixed-footer">
<div class="modal-content base-background2 white-text">
    ...
    <span class="right" id="view-account_close"><i class="bi bi-x-lg fs-1 to-h modal-close"></i></span>
    <br>
    <div class="row mt-4">
...
<div class="modal-footer base-background2">
    <!-- <a class="waves-effect btn-flat white-text to-m left hide" id="">Clear All</a> -->
    <!-- <a class="waves-effect btn-flat base-text3" id="">Edit</a> -->
</div>
</div>
